// ignore_for_file: prefer_const_constructors, prefer_const_literals_to_create_immutables, use_key_in_widget_constructors, curly_braces_in_flow_control_structures, unnecessary_this
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> _initialDataFetchAndCheckUp() async {
    ...
    final List<Map<String, dynamic>> takeUsers =
        await _cloudStoreDataManagement.getUsersAll(
    ...
    final List<dynamic> _connectionRequestList =
        await _cloudStoreDataManagement.curentUserConnLst(
