// ignore_for_file: prefer_const_constructors, prefer_final_fields, unused_field, unnecessary_this, sized_box_for_whitespace, prefer_const_literals_to_create_immutables, curly_braces_in_flow_control_structures, avoid_function_literals_in_foreach_calls
...
import 'package:chatapp/frontend/Services/chatmanager/chatscreen.dart';
import 'package:chatapp/frontend/Services/searchscreen.dart';
...
class _ChatAndActivityScreenState extends State<ChatAndActivityScreen> {
  ...
  _fetchRealTimeDataForStorage() async {
    final realTimeSnapshot =
        await _cloudStorage.fetchRealTimeDataFromFirestore();
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        floatingActionButton: extConnectionManager(),
        body: LoadingOverlay(
